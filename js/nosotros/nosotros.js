(function() {
    var content = {
        'quienes-somos': {
            title: 'Quiénes somos',
            body: '<p>Somos una startup especializada en acústica que integra ciencia, ingeniería y tecnología avanzada para transformar la manera en que ciudades e industrias gestionan el ruido. Combinamos monitoreo inteligente con sensores IoT, analítica geoespacial, modelación predictiva, gemelos digitales y soluciones de mitigación diseñadas a la medida para abordar desafíos acústicos de alta complejidad técnica.</p><p>Hemos contribuido a la formulación y soporte de política pública y ejecutado intervenciones para infraestructura crítica bajo los más altos estándares técnicos. Nuestro enfoque conecta desempeño ambiental, cumplimiento normativo y estrategia ESG, reduciendo riesgos, fortaleciendo la trazabilidad y generando valor reputacional.</p><p>En Geotrends acompañamos a empresas y territorios, transformando los desafíos acústicos en oportunidades de sostenibilidad, cumplimiento y liderazgo competitivo.</p>'
        },
        proposito: {
            title: 'Propósito',
        ...
        'reconocimientos-clientes': {
            ...
            body: '<section class="about-recon-clientes-seccion" aria-label="Reconocimientos"><h3 class="about-recon-clientes-seccion-title">Reconocimientos</h3>' +
                ...
                '<article class="about-recon-logo"><img src="../img:video/sobreNosotros/reconocimientos/image.png" alt="Reconocimiento" class="about-recon-logo-img" width="160" height="80" loading="lazy"></article>' +
                '<article class="about-recon-logo"><img src="../img:video/sobreNosotros/reconocimientos/image%20copy.png" alt="Reconocimiento" class="about-recon-logo-img" width="160" height="80" loading="lazy"></article>' +
                '<article class="about-recon-logo"><img src="../img:video/sobreNosotros/reconocimientos/image%20copy%202.png" alt="Reconocimiento" class="about-recon-logo-img" width="160" height="80" loading="lazy"></article>' +
                '<article class="about-recon-logo"><img src="../img:video/sobreNosotros/reconocimientos/image%20copy%203.png" alt="Reconocimiento" class="about-recon-logo-img" width="160" height="80" loading="lazy"></article>' +
                '<article class="about-recon-logo"><img src="../img:video/sobreNosotros/reconocimientos/image%20copy%205.png" alt="Reconocimiento" class="about-recon-logo-img" width="160" height="80" loading="lazy"></article>' +
                '</div></div></section>' +
                ...
                '<li class="about-clientes-logo-item"><img src="../img:video/clientes/image.png" alt="Cliente" class="about-clientes-logo-img" width="120" height="48" loading="lazy"></li>' +
                '<li class="about-clientes-logo-item"><img src="../img:video/clientes/image%20copy.png" alt="Cliente" class="about-clientes-logo-img" width="120" height="48" loading="lazy"></li>' +
                '<li class="about-clientes-logo-item"><img src="../img:video/clientes/image%20copy%202.png" alt="Cliente" class="about-clientes-logo-img" width="120" height="48" loading="lazy"></li>' +
                '<li class="about-clientes-logo-item"><img src="../img:video/clientes/image%20copy%203.png" alt="Cliente" class="about-clientes-logo-img" width="120" height="48" loading="lazy"></li>' +
                '</ul></div></section>'
        }
    };
