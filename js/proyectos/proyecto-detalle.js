(function() {
    ...
    if (proyecto === 'refineria-cartagena' && typeof REFINERIA_CARTAGENA_IMAGES !== 'undefined' && REFINERIA_CARTAGENA_IMAGES.length) {
        ...
        base = '../../img:video/proyectos/industria/refineriaCartagena/';
